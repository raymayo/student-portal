    ...
    return (
        <main className="h-full w-full bg-zinc-100 flex flex-col justify-center items-center gap-4">
            ...
            <div className="flex gap-1.5 items-center">
                <div className="border p-1 rounded-lg bg-zinc-900 text-zinc-200">
                <GraduationCap size={18}/>
                </div>
                <h1 className="font-medium">Acadex Portal</h1>
            </div>
            <form onSubmit={handleSubmit} className="w-full max-w-[400px] flex flex-col justify-center items-center gap-2 p-6 bg-white rounded-xl shadow-md border border-zinc-200">
                ...
                <button type="submit" className="px-3 py-2 rounded-lg font-medium bg-zinc-900 border text-zinc-100 text-sm w-full shadow-2xs cursor-pointer">
                    Login
                </button>
                </div>
            </form>
